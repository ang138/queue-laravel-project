...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('assets/images/slide6.jpg') }}" class="d-block w-100" alt="ภาพที่ 1">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('assets/images/slide5.jpg') }}" class="d-block w-100" alt="ภาพที่ 2">
        </div>
        <div class="carousel-item">
            <img src="{{ asset('assets/images/slide4.jpg') }}" class="d-block w-100" alt="ภาพที่ 3">
        </div>
    </div>
